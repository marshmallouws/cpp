...
private:
	...
	/*
	 * Map from a currency to its exchange rate with DKK
	 */
...
public:
	 ...
	 * DKK will be used as the base currency. All further introduced currencies will e provided with the exchange rate to DKK
	 */
	CurrencyConverter();
